...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/robustness_single_feature_auc_drop.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/robustness_group_auc_drop.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/evaluation_reliability_diagrams.png}
